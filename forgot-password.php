...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($_POST["password"]) && empty($_POST["cpassword"])){
         echo "<script>alert('Password and Confirm can't be empty')</script>";    
    }else{
...
<head>
    ...
    <title>Forgot Password | Online Catering System</title>
        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Forgot Password</p>
                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form action="<?php htmlspecialchars('php_self'); ?>" method="POST">
                                ...
                                <div class="mb-3"><input class="btn btn-primary shadow d-block w-100" type="submit" name="submit" value="Forgot Password"/></div>
    ...
    <!-- if (mysqli_num_rows($check_email) > 0) {
                    while ($row = mysqli_fetch_assoc($check_email)) {
                        ...
                        if ($db_password == $password) {
                            ...
                            echo "<script>alert('Password is incorrect.</div>');";
                        }
                    }
                } else {
